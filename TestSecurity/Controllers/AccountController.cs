...
namespace TestSecurity.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, IsActiveDirectoryUser = model.IsActiveDirectoryUser };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public virtual ActionResult LogOff(LoginViewModel model)
        {
